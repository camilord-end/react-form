...
const StepperControl = () => {
  return (<div className='container flex justify-around mt-4 mb-8'>
      ...
      {/* Next button */}
      <button className='bg-purple-500 text-white uppercase py-2 px-4 rounded-xl font-semibold cursor-pointer hover:bg-purple-900 hover:text-white transition duration-2oo ease-in-out'>
        Next
      </button>
    </div>
  )
